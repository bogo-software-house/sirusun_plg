...
var require_plugin2 = __commonJS({
  "node_modules/flowbite/plugin.js"(exports, module) {
    ...
    var { spacing, borderWidth, borderRadius, boxShadow } = defaultTheme;
...
// node_modules/flowbite-react/dist/esm/tailwind.mjs
var import_plugin = __toESM(require_plugin2(), 1);
function content({ base = "./" } = {}) {
  const path = "node_modules/flowbite-react/dist/esm/**/*.mjs";
  return `${base}${path}`;
}
function plugin() {
  return import_plugin.default;
}
export {
  content,
  plugin
};
//# sourceMappingURL=flowbite-react_tailwind.js.map
