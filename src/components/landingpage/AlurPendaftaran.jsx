...
const timeline = [
  {
    id: 1,
    content: "Download,isi formulir & Upload persayaratan di website resmi sirusun",
    icon: UserIcon,
  },
  {
    id: 2,
  ...
  {
    id: 3,
    content: "Mengecek Ketersedian Unit,Jika tersedia lanjut ke pemabayaran,jika penuh maka masuk keantrian",
    icon: CheckIcon,
  },
  {
    id: 4,
...
const persyaratan = [
  ...
  {
    id: 2,
    syarat: "Kartu Keluarga Palembang",
    nomor: "2",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    nomor: "4",
    surat: ["Bekeluarga", "Dalam 1 KK tidak ada ASN,TNI, dan POLRI", "Masuk Keluarga Miskin"],
  },
  {
    id: 5,
  ...
  return (
    <>
      <div className="mx-auto max-w-2xl text-center my-10 lg:my-20">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Alur dan Pendaftaran</h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">Silahkan Melihat Informasi Syarat dan Prosedur Pendaftaran</p>
      </div>
