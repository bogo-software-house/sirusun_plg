        ...
        <div className="mx-auto mt-6 max-w-6xl sm:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 lg:gap-6 lg:px-6">
          {rusun.image1 && (
            <div className="flex justify-center">
              <img src={rusun.image1} alt="Gambar 1" className="w-full h-72 rounded-lg object-cover lg:h-64" />
            </div>
          )}
          {rusun.image2 && (
            <div className="flex justify-center">
              <img src={rusun.image2} alt="Gambar 2" className="w-full h-72 rounded-lg object-cover lg:h-64" />
            </div>
          )}
          {rusun.image3 && (
            <div className="flex justify-center">
              <img src={rusun.image3} alt="Gambar 3" className="w-full h-72 rounded-lg object-cover lg:h-64" />
            </div>
          )}
          {rusun.image4 && (
            <div className="flex justify-center">
              <img src={rusun.image4} alt="Gambar 4" className="w-full h-72 rounded-lg object-cover lg:h-64" />
            </div>
          )}
        </div>
                  ...
                  {blok.lantai &&
                    blok.lantai.map((lantai) => (
                      <div className="text-black bg-white rounded-md p-2 shadow-md mb-4 " key={lantai.lantai}>
                        <img src={gambarKamar} alt={`Gambar Lantai ${lantai.lantai}`} />
