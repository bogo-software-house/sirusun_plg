...
use App\Models\Berkas_scan_kk;
use App\Http\Resources\Berkas_scan_kkResource;
use Illuminate\Support\Facades\Validator;

class Berkas_scan_kkController extends Controller
{
    /**
    ...
    {
        $berkas_scan_kks = Berkas_scan_kk::Latest()->paginate(5);
        return new Berkas_scan_kkResource(true, 'List Data Berkas Scan KK',$berkas_scan_kks);
    }
