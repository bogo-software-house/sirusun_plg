...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('rooms', function (Blueprint $table) {
            ...
            $table->string('damage_rooms_fn_flatfond_custom_id');
            $table->string('damage_rooms_fn_dinding_custom_id');
            $table->string('damage_rooms_instalasi_listrik_custom_id');
            $table->string('damage_rooms_instalasi_air_custom_id');
            $table->timestamps();
